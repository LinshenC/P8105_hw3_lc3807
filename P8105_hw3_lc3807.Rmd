...
```
According to table, there are no big difference between the number male and the number of female in each in each education category. However, in education category "More Than High School", the number of female with age between 25 and 40 is much larger than the number of female with same age based on density plot.
